...
def tdc_mpp__sed(ID, timeshots, xxs, **kwargs):
    """
    ...
    # time label format
    timelabel_format = kwargs.get('timelabel_format',__timelabel_format)
    # default energy bins
    if not kwargs.get('p_bins'):
    ...
    mpp = tdc_MPP_SED_Timeseries_H( sp, timeshots, xxs, **kwargs)
    return mpp
