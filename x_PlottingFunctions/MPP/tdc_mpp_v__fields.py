...
from ATvis.MPP import AT_MPP_Comparative_Timeseries_V
...
def tdc_mpp_v__e_rho_n(ID,timeshots,
    ...
    Returns:
    --------
    ()=>  AT_MPP_Comparative_Timeseries_V instance with the plot
    """
    # electric field
    ...
    # MFP instance
    mpp = AT_MPP_Comparative_Timeseries_V( (fp1,fp2,fp3), timeshots, fig_param=fig_param)
    return mpp
...
def tdc_mpp_v__e_fft_discharge(ID,timeshots,
    ...
    # MFP instance
    mpp = AT_MPP_Comparative_Timeseries_V( (fp1,sp1,sp2), timeshots, fig_param=fig_param)
    return mpp
...
def tdc_mpp_v__e_n_fft(ID,timeshots,
    ...
    if moving_grid_dict:
        ...
        fp2 = tdc_Moving_Grid_Plotter(fp2,moving_grid_dict)
    # MFP instance
    mpp = AT_MPP_Comparative_Timeseries_V( (fp1,sp1,fp2), timeshots, fig_param=fig_param)
    return mpp
