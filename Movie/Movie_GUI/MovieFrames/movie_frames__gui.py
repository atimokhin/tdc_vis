...
class MovieFrames__GUI(MovieFrames__Axes):
    """
    ...
    def _setup_axes(self,xlim,ylim, axes_commands):
        ...
        """
        MovieFrames__Axes._setup_axes(self,xlim,ylim, axes_commands)
    ...
    def replot(self,**kwargs):
        ...
        """
        # do plot
        MovieFrames__Axes.plot(self,animated=True,**kwargs)
        self._plot_axes_labels()
        self._execute_axes_commands()
...
#        self.canvas.draw()
    ...
    def axes_setup_panel(self, parent_widget):
        ...
        """
        from ..GUI.axes_setup import Axes_Setup_Window
